package com.example.springbootWithAws.config.auth;

import com.example.springbootWithAws.config.auth.dto.OAuthAttributes;
import com.example.springbootWithAws.config.auth.dto.SessionUser;
import com.example.springbootWithAws.domain.user.SocialUser;
import com.example.springbootWithAws.domain.user.UserRepository;
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        return new DefaultOAuth2User(
                Collections.singleton(new
                        SimpleGrantedAuthority(socialUser.getRoleKey())),
